  ...
  const areas = [
    {
      title: "Education",
      description:
        "Improving access to quality education and creating learning opportunities for underprivileged youth.",
      color: "bg-blue-100 text-blue-900",
    },
    {
      title: "Healthcare",
      description:
        "Promoting health awareness and providing support to communities lacking basic healthcare facilities.",
      color: "bg-green-100 text-green-900",
    },
    {
      title: "Livelihood",
      description:
        "Empowering individuals with skills and resources for economic self-sufficiency and sustainable livelihoods.",
      color: "bg-yellow-100 text-yellow-900",
    },
    {
      title: "Environment",
      description: "Advocating for environmental conservation and promoting sustainable practices in our communities.",
